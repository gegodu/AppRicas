...
functions = {
    ...
    user: function(req, res){
        ...
        request.get('https://api.twitter.com/1.1/statuses/user_timeline.json?screen_name=' + encsearchquery +
        '&count=20', {headers: {Authorization: bearerheader}}, function(error, body, response){
    ...
    followers: function(req, res){
        ...
        request.get('https://api.twitter.com/1.1/followers/list.json?screen_name=' + encsearchquery
